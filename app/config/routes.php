 ...
 */
	...
	Router::connect('/admin/login', array('controller' => 'accounts', 'action' => 'login', 'admin' => true));
	Router::connect('/login', array('controller' => 'accounts', 'action' => 'login'));
	Router::connect('/logout', array('controller' => 'accounts', 'action' => 'logout'));
	Router::connect('/img/:id', array('controller' => 'filesystems', 'action' => 'view'), array('pass' => array('id'), 'id' => '[0-9]+'));
?>
